...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: LoginPage(), // Corrected class name to PascalCase
    );
  }
}
            ...
            children: [
              ...
              Center(
                child: Image.network(
                  height: 100,
                  width: 100,
                  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6tv3elaEzsHKSsmXKYEx_ByCYtAa7APk1SA&s",
                ),
              ),
              const SizedBox(
                height: 10,
              ...
              const TextField(
                decoration: InputDecoration(
                  hintText:
                      "Email Address", // Text inside the TextField when empty
                  hintStyle: TextStyle(
                  ...
                  filled: true,
                  fillColor: Color.fromRGBO(226, 223, 223, 0.879),
              ...
              Row(
                ...
                children: [
                  // Facebook Icon with background color
                  const Icon(
                    Icons.facebook,
                    color: Colors.blue, // Icon color
                    size: 40.0,
                  ),
                  const SizedBox(width: 20.0), // Add some spacing between icons
                  // Google Icon without background color
                  Container(
                    height: 40.0,
                    width: 40.0,
                    decoration: const BoxDecoration(
                      shape: BoxShape.circle, // Circle shape for the background
                    ),
                    child: Image.network(
