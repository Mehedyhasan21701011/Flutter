...
import 'package:my_project/Module/class%2015-19/getex/getControler.dart';
...
class Gethome extends StatelessWidget {
  ...
  final getcontroler controller = Get.put(getcontroler());

  final TextEditingController updatedContentController = TextEditingController();
  @override
            ...
            ElevatedButton(
                onPressed: () {
                  if (newNoteController.text.isNotEmpty) {
                    controller.noteAdd(newNoteController.text);
